# genpark-hierarchical-creator-tiering-matrix-allocator-skill
...
> **GenPark AI Agent Skill** -- Hierarchical creator tiering matrix allocator & media mix (Kolsquare style)
